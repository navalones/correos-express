            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-xs-12 col-md-12 col-lg-12 text-center">
                        <img src="<?php echo esc_url(plugins_url('/../img/logo-correosexpress.png',__FILE__));?>"
                            class="img-fluid mx-auto d-block" id="img-correos-express">
                    </div>
                    <div class="col-12 col-xs-12 col-md-12 col-lg-6 mt-5">
                        ...
                        <div class="row mt-3 d-flex aling-items-center">
                            ...
                            <div class="col-10 col-xs-10">
                                ...
                                <p><?php esc_html_e("Correos Express ofrece, en exclusiva y ","cex_pluggin");?><strong
                                        class="CEX-text-red"><?php esc_html_e("sin coste adicional","cex_pluggin");?></strong><?php esc_html_e(",el servicio de entrega en oficina de Correos.","cex_pluggin");?>
                                </p>
                        ...
                        <div class="row mt-3 d-flex aling-items-center">
                            ...
                            <div class="col-10 col-xs-10">
                                <h4 class="CEX-text-red mt-0"><?php esc_html_e("ENTREGA CUANTO ANTES.","cex_pluggin");?>
                                </h4>
                    ...
                    <div class="col-12 col-xs-12 col-md-12 col-lg-6 mt-5 mb-0 pt-3">
                        <div id="CEX-esCliente" class="jumbotron p-4 rounded-0 d-block d-sm-flex mb-0">
                            <h3 class="d-block d-sm-inline-block my-auto CEX-font-size-1-5">
                                <strong><?php _e("Hola,<br/>¿Eres cliente<br/> de <span class='CEX-text-blue'>Correos</span> <span class='CEX-text-red'>Express</span>?","cex_pluggin");?></strong>
                            </h3>
                            <button
                                class="d-block d-sm-inline-block CEX-btn btn-large CEX-button-red m-0 text-uppercase float-sm-right mt-5 ml-3 px-2 py-3"
                        ...
                        <div class="CEX-card mt-0 rounded-0 shadow-none">
                            ...
                            <form id="CEX-form_info">
                                ...
                                <div class="form-group w-75 mx-auto">
                                    ...
                                    <span class="label_required CEX-text-red">*</span><span
                                ...
                                <div id="CEX-gdpr" class="form-group">
                                    <div id="CEX-gdpr-info" class="CEX-text-gris-oscuro">
                                ...
                                <div class="form-group w-75 mx-auto">
                                    <button id="guardar_form" class="CEX-btn CEX-button-red" name="Envio"
