...
<script type="text/javascript">
	...
	var buscador_oficinas = "<li id='CEX'><div id='oficina' class='d-none form-group mt-5'>"+
			...
			"<button name='buscador_oficina' id='buscador_oficina' class='CEX-btn CEX-button-blue' onclick='mostrarBuscador(event);'><?php _e('Buscar oficina', 'cex_pluggin')?></button>"+
	...
	var ContenedorOficinas = "<div id='CEX' class='none'><div id='CEX-loading' class='cexmodal d-none'></div>"+
							"<div id='buscador_ofiCabecera' class='d-none mb-2'><h3 class='my-auto CEX-text-blue w-75 d-inline-block'><strong><?php esc_html_e('Buscador de Oficinas', 'cex_pluggin');?></strong></h3><img src='<?php echo esc_url(plugins_url().'/correos-express/views/img/correosexpress.png');?>' class='img-fluid w-25 d-inline-block'></div>"+
							"<div id='buscador_ofi' class='CEX-card-front CEX-text-white p-0 d-none'>"+
							...
							"<button class='CEX-btn CEX-button-red' name='buscar_oficina' value='' onclick='buscarOficina(event);'>"+
